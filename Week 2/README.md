...
## Overview
This week deepens understanding of Security Operations Center (SOC) workflows by focusing on effective alert handling, incident classification, and coordinated response activities.
Students will learn how to assess alert severity, map incidents to recognized frameworks like MITRE ATT&CK and ENISA, and execute response actions using real-world SOC tools such as Wazuh, TheHive, and Velociraptor.
Emphasis is placed on practical, standards-based operations following NIST SP 800-61 and CVSS methodologies
...
-  **Alert Priority Levels Learn:**
  - Understand severity levels and their criteria (Critical, High, Medium, Low)  
  - Learn prioritization using CVSS, asset criticality, and exploit likelihood  
  - Apply CVSS scoring (e.g., Log4Shell CVSS 9.8 = Critical)  
  - References:
    - FIRST CVSS Guide  
    - NIST SP 800-61  
...
-  **Incident Classification Learn:**
  ...
  - Practice: Classify and enrich incidents using MITRE ATT&CK mappings  

---

-  **Basic Incident Response Learn:**
...
5️⃣ Capstone Project: Full Alert-to-Response Cycle**
  - **Activities:**  
